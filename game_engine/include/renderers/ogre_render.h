#ifndef RENDERERS_OGRE_RENDER_H
#define RENDERERS_OGRE_RENDER_H
...
namespace asw{
	class OgreRender : public Render{
		private:
			Ogre::Root * ogre_root; // Ogre Core
			Ogre::RenderWindow * OgreRender_window;
		...
		//	static OgreRender * render_manager;
			virtual void renderInit(core * core_manager, const std::string &dox);
			virtual void guiInit(const std::string &dox);
		...
		protected:
			 ...
			 */
			OgreRender(core * core_manager, const std::string &dox);
			/*!
		...
		public:
			 ...
			 */
			static OgreRender * getSingletonPtr();
			
			virtual void beginRender();
			virtual void createGui(const std::string &gui_dox);
			 ...
			 */
			virtual std::string activeLevel();
			 ...
			 */
			virtual void changeLevel(const std::string &level_name);
			/*!
			 ...
			 *	does not exist.
			 */
			virtual void translateObject(const std::string &obj, float x, float y, float z);
			/*!
			 ...
			 *	does not exist.
			 */
			virtual void rotateObject(const std::string &obj, axis_t &axis, rotation_t &type, float w);
			/*!
			 ...
			 *	does not exist.
			 */
			virtual void scaleObject(const std::string &obj, float x, float y, float z);
			/*!
			 ...
			 *	does not exist.
			 */
			virtual void revealObject(const std::string &obj);
			/*!
			 ...
			 */
			virtual void hideObject(const std::string &obj);
			/*!
			 ...
			 *	key does not interact properly with the GUI.
			 */
			virtual void mouseClicked(uint8 id, std::vector<int> &abs, std::vector<int> &rel);
			/*!
			 ...
			 *	key does not interact properly with the GUI.
			 */
			virtual void mouseReleased(uint8 id, std::vector<int> &abs, std::vector<int> &rel);
			/*!
			 ...
			 *	key does not interact properly with the GUI.
			 */
			virtual void mouseMoved(std::vector<int> &abs, std::vector<int> &rel);
			/*!
			 ...
			 *	\return void
			 */
			virtual void updateAudio(float ts);
			/*!
			 *	\brief Method to request the core manager to check the status
			 *	of inputs.
			 ...
			 *	\return void
			 */
			virtual void pollInputs(float ts);
			/*!
			 ...
			 *	\return void
			 */
			virtual void callScript(const std::string &script, std::vector<std::string> &args);
			 ...
			 */
			virtual void createSceneManager(const std::string &name);
			/*!
			 ...
			 */
			virtual void loadSceneManager(const std::string &name);
			/*!
			 ...
			 */
			virtual void addLocation(const std::string &loc, const std::string &group);
			/*!
			 ...
			 *	exist.
			 */
			virtual void declareResource(const std::string &file, const std::string &type, const std::string &group);
			 ...
			 *	does not exist.
			 */
			virtual void addBase(object_resource * obj_src);
			/*!
			 ...
			 *	does not exist.
			 */
			virtual void addSkin(const std::string &base, const std::string &material, const std::string &grp);
	//		/*!
	...
	//		virtual void add_light(const std::string &name, std::vector<float> &colour);
			 ...
			 */
			virtual void attachObject(const std::string &node, const std::string &object_name, object_t &object);
			// Animation
			/*!
			 ...
			 */
			virtual void addAnimation(const std::string &node, const std::string &animation_name, const float &time, const uint16 track);
			/*!
			 ...
			 */
			virtual void addFrame(const std::string &animation_name, const uint16 track, const float time, std::vector<anim_resource*> vals);
	};
}
